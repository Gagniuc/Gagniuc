...
Note: all applications are designed natively in their respective programming or scripting languages, without libraries and dependencies. Thus, the applications have no dependencies and can be used offline. There are about 100 posts [here](https://github.com/Gagniuc?tab=repositories), however, below are some useful projects that I have chosen to show as a preview:
